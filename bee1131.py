...
pelo Inter e pelo Grêmio respectivamente. 
...
"Novo grenal (1-sim 2-nao)". Quando o algoritmo for encerrado devem ser mostradas 
as estatísticas conforme a descrição apresentada acima. Obs: a palavra "Gremio" deve ser impressa sem acento, conforme o exemplo abaixo.
...
grenais = 0
while True:
    gol_1,gol_2 = list(map(int,input().split()))
    if(gol_1>gol_2):
        inter +=1
    if(gol_1<gol_2):
        gremio +=1
